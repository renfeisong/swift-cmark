...
static void source_pos_fixes_author(test_batch_runner *runner) {
  {
    static const char markdown[] =
...
static void source_pos_fixes_custom(test_batch_runner *runner) {
  {
    static const char markdown[] =
        "A\n"
        "  **foo**\n"
    ...
    STR_EQ(runner, xml, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
                        "<!DOCTYPE document SYSTEM \"CommonMark.dtd\">\n"
                        "<document sourcepos=\"1:1-14:7\" xmlns=\"http://commonmark.org/xml/1.0\">\n"
                        "  <paragraph sourcepos=\"1:1-2:9\">\n"
                        "    <text sourcepos=\"1:1-1:1\" xml:space=\"preserve\">A</text>\n"
                        "    <softbreak />\n"
                        "    <strong sourcepos=\"2:3-2:9\">\n"
                        "      <text sourcepos=\"2:5-2:7\" xml:space=\"preserve\">foo</text>\n"
                        "    </strong>\n"
                        "  </paragraph>\n"
                        "  <paragraph sourcepos=\"5:3-6:7\">\n"
                        "    <text sourcepos=\"5:3-5:3\" xml:space=\"preserve\">B</text>\n"
                        "    <softbreak />\n"
                        "    <strong sourcepos=\"6:1-6:7\">\n"
                        "      <text sourcepos=\"6:3-6:5\" xml:space=\"preserve\">bar</text>\n"
                        "    </strong>\n"
                        "  </paragraph>\n"
                        "  <paragraph sourcepos=\"9:1-10:9\">\n"
                        "    <text sourcepos=\"9:1-9:1\" xml:space=\"preserve\">A</text>\n"
                        "    <linebreak />\n"
                        "    <strong sourcepos=\"10:3-10:9\">\n"
                        "      <text sourcepos=\"10:5-10:7\" xml:space=\"preserve\">baz</text>\n"
                        "    </strong>\n"
                        "  </paragraph>\n"
                        "  <paragraph sourcepos=\"12:2-14:7\">\n"
                        "    <text sourcepos=\"12:2-12:2\" xml:space=\"preserve\">A</text>\n"
                        "    <softbreak />\n"
                        "    <text sourcepos=\"13:3-13:3\" xml:space=\"preserve\">B</text>\n"
                        "    <softbreak />\n"
                        "    <strong sourcepos=\"14:1-14:7\">\n"
                        "      <text sourcepos=\"14:3-14:5\" xml:space=\"preserve\">bif</text>\n"
                        "    </strong>\n"
                        "  </paragraph>\n"
                        "</document>\n",
                        "sourcepos (fixes:1) are as expected");
    free(xml);
    cmark_node_free(doc);
  }
  /*
...
int main() {
  ...
  source_pos_fixes_author(runner);
  source_pos_fixes_custom(runner);
